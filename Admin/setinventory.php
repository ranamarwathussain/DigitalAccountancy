...
if(isset($_POST['save'])){
    extract($_POST);
         ...
         { 
          ...
          $queryprice=mysqli_query($conn,"select sum(price) as totalprice from  inventory where cid ='$category' And month='$getmonth' and year='". $yearcheck."' and createdby='".$_SESSION['email']."'");
          ...
          $query1=mysqli_query($conn,"select * from  inventory where cid ='$category' and icode='$item' And month='$getmonth' and price='$price' and quantity='$quantity' and year='".$yearcheck."' and createdby='".$_SESSION['email']."'");
 ...
 if (isset($_GET['Id']) && isset($_GET['action']) && $_GET['action'] == "edit")
  {
        ...
        $query=mysqli_query($conn,"select * from  inventory where iid ='$Id'");
        ...
        if(isset($_POST['update'])){
            ...
            $query2=mysqli_query($conn,"select * from  inventory where iid ='$Id'");
    ...
    if($getmonth1>0)
    {
      ...
      } else
      {
            ...
            $query=mysqli_query($conn,"update inventory set price='$price',quantity='$quantity',location='$location' where iid='$Id'");
...
//--------------------------------DELETE------------------------------------------------------------------
  ...
  if (isset($_GET['Id']) && isset($_GET['action']) && $_GET['action'] == "delete")
  {
        ...
        $query = mysqli_query($conn,"DELETE FROM  inventory WHERE iid='$Id'");
...
function showUser(str) {
  if (str == "") {
    ...
    xmlhttp.open("GET","getitemname1.php?q="+str,true);
    xmlhttp.send();
  }
}
</script>
      ...
      ?>
                  <form method="post">
                    ...
                    <div class="col-xl-6">
                      ...
                      <input type="number" class="form-control" name="price" value="<?php echo $row['price'];?>"   placeholder="Price" oninput="this.value = this.value.toUpperCase()" required>
                        </div>
                        <div class="col-xl-6">
                    ...
                    {
                    ?>
                     <button type="button"  onclick="window.location.href='setinventory.php'" name="addvendor" class="btn btn-primary">Add New Expense</button>
              ...
              <div class="card mb-4">
                ...
                <div class="table-responsive p-3">
                  ...
                  <?php
                      $query = "SELECT * FROM inventory where createdby='".$_SESSION['email']."' ";
                      $rs = $conn->query($query);
                      $num = $rs->num_rows;
                        ...
                        while ($rows = $rs->fetch_assoc())
                          {
                            ...
                            echo"
                              <tr>
                                ...
                                {
                                echo "
                                <td style='color:red;'>".$rows['category']."</td>
                                 <td>".$rows['itemname']."</td>
                                 <td>".$rows['price']."</td>
                                 <td>".$rows['quantity']."</td>
                                 <td>".$rows['location']."</td>
                            ...
                            {
                              echo"
                                <strong><td style='color:green;'>".$rows['category']."</td></strong>";
                              echo "
                                 <td>".$rows['itemname']."</td>
                                 <td>".$rows['price']."</td>
                                 <td>".$rows['quantity']."</td>
