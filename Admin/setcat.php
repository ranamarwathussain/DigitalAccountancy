...
if(isset($_POST['save'])){
    ...
    $query=mysqli_query($conn,"select * from category where category ='$category' and createdby='".$_SESSION['email']."' ");
    ...
    if($ret > 0){ 
        ...
        $query=mysqli_query($conn,"insert into category value('','$category','".$_SESSION['email']."')");
 ...
 if (isset($_GET['Id']) && isset($_GET['action']) && $_GET['action'] == "edit")
	{
        ...
        $query=mysqli_query($conn,"select * from category where cid ='$Id'");
        ...
        if(isset($_POST['update'])){
            ...
            $query=mysqli_query($conn,"update category set category='$category' where cid='$Id'");
  ...
  if (isset($_GET['Id']) && isset($_GET['action']) && $_GET['action'] == "delete")
	{
        ...
        $query = mysqli_query($conn,"DELETE FROM category WHERE cid='$Id'");
        ...
        <div class="container-fluid" id="container-wrapper">
          <div class="d-sm-flex align-items-center justify-content-between mb-4">
            ...
            <ol class="breadcrumb">
              ...
              <li class="breadcrumb-item active" aria-current="page">Set Category</li>
            </ol>
          </div>
            ...
            <div class="col-lg-12">
              ...
              <div class="card mb-4">
                <div class="card-header py-3 d-flex flex-row align-items-center justify-content-between">
                  <h6 class="m-0 font-weight-bold text-primary">Set Category Section</h6>
                    <?php echo $statusMsg; ?>
                </div>
                <div class="card-body">
                  <form method="post">
                    <div class="form-group row mb-3">
                      ...
                      <input type="text" class="form-control" name="category" value="<?php echo $row['category'];?>"   placeholder="Category" oninput="this.value = this.value.toUpperCase()" required>
                        </div>
  </div>
                    ...
                    <button type="button"  onclick="window.location.href='setcat.php'" name="addvendor" class="btn btn-primary">Set New Category</button>
                     
                    &nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;
                    <?php
                    } else {           
                    ?>
                    <button type="submit" name="save" class="btn btn-success">Set Category</button>
                    <?php
                    }         
                    ?>
                  </form>
              ...
              <div class="card mb-4">
                <div class="card-header py-3 d-flex flex-row align-items-center justify-content-between">
                  <h6 class="m-0 font-weight-bold text-primary">Category's Data</h6>
                </div>
                <div class="table-responsive p-3">
                  <table class="table align-items-center table-flush table-hover" id="dataTableHover">
                    <thead class="thead-light">
                      <tr>
                        <th>Created Categories</th>
                        <th>EDIT</th>
                        <th>Delete</th>
                      </tr>
                    </thead>
                  ...
                  <?php
                      $query = "SELECT * FROM category where createdby='".$_SESSION['email']."' ";
                      $rs = $conn->query($query);
                      $num = $rs->num_rows;
                        ...
                        while ($rows = $rs->fetch_assoc())
                          {
                            ...
                            echo"
                              <tr>
                                ...
                                <td>".$rows['category']."</td>";
                               echo " <td><a href='?action=edit&Id=".$rows['cid']."'><i class='fas fa-fw fa-edit'></i></a></td>
                                <td><a href='?action=delete&Id=".$rows['cid']."'><i class='fas fa-fw fa-trash'></i></a></td>
                              </tr>";
