			...
			<div class="form-right">
				...
				<form class="form-detail" action="register.php" method="post">
					<div class="tabcontent" id="sign-up">
						...
						<div class="form-row">
							<label class="form-row-inner">
								<input type="email" name="emailprimary" id="your_email" class="input-text" required>
						...
						<div class="form-row">
							<label class="form-row-inner">
								<input type="number" name="hnumber" id="comfirm_password" class="input-text" required>
						...
						<div class="form-row">
							<label class="form-row-inner">
								<input type="number" name="fnumber" id="comfirm_password" class="input-text" required>
				...
				<form class="form-detail" action="login.php" method="post">
					<div class="tabcontent" id="sign-in">
						...
						<div class="form-row">
							<label class="form-row-inner">
								<input type="email" name="your_email_1" id="your_email_1" class="input-text" required>
								<span class="label">E-Mail</span>
		  						<span class="border"></span>
							</label>
						</div>
